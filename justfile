...
tarpaulin_base := "tarpaulin --workspace --all-features --timeout 120 --exclude-files src/main.rs src/tests.rs src/*/tests.rs packaging/**/*.rs --ignore-tests --target-dir $PWD/target-cov --skip-clean"
